...
run_test() {
  ...
  log_info "Step 1: GET /api/v1/rvinfo - Verify empty state"
  ...
  log_info "Step 2: PUT /api/v1/rvinfo - Test validation (missing DNS/IP)"
  invalid_rvinfo='[[
    {"protocol": "http"},
    {"owner_port": 8080}
  ]]'
  ...
  log_info "Step 3: PUT /api/v1/rvinfo - Create initial configuration"
  initial_rvinfo='[[
    {"dns": "rv.example.com"},
    {"protocol": "https"},
    {"owner_port": 8443}
  ...
  log_info "Step 4: GET /api/v1/rvinfo - Verify creation"
  response=$(get_rendezvous_info "${manufacturer_url}")
  log_info "Response: ${response}"
  ...
  log_info "Step 5: PUT /api/v1/rvinfo - Update with RV bypass"
  bypass_rvinfo='[[
  ...
  log_info "Step 7: PUT /api/v1/rvinfo - Update with multiple directives"
  multi_rvinfo='[
    [
  ...
  log_info "Step 8: GET /api/v1/rvinfo - Verify multiple directives"
  response=$(get_rendezvous_info "${manufacturer_url}")
  ...
  log_info "Step 9: DELETE /api/v1/rvinfo - Delete configuration"
  ...
  log_info "Step 10: GET /api/v1/rvinfo - Verify deletion"
  response=$(get_rendezvous_info "${manufacturer_url}")
